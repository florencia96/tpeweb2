...
{
    return ssectionslashes($matches[ 1 ]) . mb_convert_case(ssectionslashes($matches[ 2 ]), MB_CASE_UPPER, Smarty::$_CHARSET);
}
...
{
    return ssectionslashes($matches[ 1 ]) . mb_convert_case(ssectionslashes($matches[ 3 ]), MB_CASE_UPPER, Smarty::$_CHARSET);
}
...
{
    return ssectionslashes($matches[ 1 ]) . ucfirst(ssectionslashes($matches[ 2 ]));
}
...
{
    return ssectionslashes($matches[ 1 ]) . ucfirst(ssectionslashes($matches[ 3 ]));
}
